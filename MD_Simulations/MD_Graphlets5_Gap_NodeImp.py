...
for r in datasets:
    ...
    model.load_state_dict(torch.load(
        f'MD_TAG_Models/MD_model_Graphlets5Gap_4TAG_64HC3D001LR0001WD3K_{r}_{sys.argv[-1]}'))
...
all_ranks.to_excel(f'MD_TAG_Results/MD_Graphlets5_Gap_TAG_{sys.argv[-1]}.xlsx')

with open(f'MD_TAG_Results/MD_Graphlets5Gap_All_Predictions_TAG_{sys.argv[-1]}.json', 'w') as f:
