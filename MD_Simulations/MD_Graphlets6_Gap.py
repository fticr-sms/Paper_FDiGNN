...
with open('Data/MD_6Graphlets_gaps.txt') as a:
...
for r in datasets:
    ...
    while best_loss > 0.15:
        ...
        print('----------------------------------------')
        print('\n')
        torch.save(best_model.state_dict(), f'MD_TAG_Models/MD_model_Graphlets6Gap_4TAG_64HC3D001LR0001WD3K_{r}_{sys.argv[-1]}')
