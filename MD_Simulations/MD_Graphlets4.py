...
with open('Data/MD_GNNPathwayTest_graphlets_size4.txt') as a:
    gs = a.read().split('\n')

with open('Data/MD_GNNPathwayTest_singlenodes_size4.txt') as a:
    sns_p = a.read().split('\n')
...
for r in datasets:
    ...
    while best_loss > 0.15:
        ...
        print('----------------------------------------')
        print('\n')
        torch.save(best_model.state_dict(), f'MD_TAG_Models/MD_model_Graphlets4_4TAG_64HC3D001LR0001WD3K_{r}_{sys.argv[-1]}')
