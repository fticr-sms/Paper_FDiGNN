...
for r in datasets:
    ...
    model.load_state_dict(torch.load(
        f'LID_TAG_Models/LID_model_Graphlets4_4TAG_64HC15D001LR0001WD_{r}_{sys.argv[-1]}'))
...
all_ranks.to_excel(f'LID_TAG_Results/LID_Graphlets4_Normal_TAG_{sys.argv[-1]}.xlsx')

with open(f'LID_TAG_Results/LID_Graphlets4_All_Predictions_TAG_{sys.argv[-1]}.json', 'w') as f:
