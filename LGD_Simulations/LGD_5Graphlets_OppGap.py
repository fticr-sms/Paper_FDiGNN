...
for r in datasets:
    ...
    torch.save(best_model.state_dict(), f'LGD_Models/LGD_model_Graphlets5OppGap_4TAG_64HC3D005LR0001WD140E_{r}_{sys.argv[-1]}')
    print(f'Graphlets 5 OppGap - {r} {sys.argv[-1]}.')
