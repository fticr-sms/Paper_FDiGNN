...
with open('Data/LGD_GNNPathwayTest_graphlets_size4.txt') as a:
    gs = a.read().split('\n')

with open('Data/LGD_GNNPathwayTest_singlenodes_size4.txt') as a:
    sns_p = a.read().split('\n')
...
for r in datasets:
    ...
    torch.save(best_model.state_dict(), f'LGD_Models/LGD_model_Graphlets4_4TAG_64HC3D005LR0001WD140E_{r}_{sys.argv[-1]}')
