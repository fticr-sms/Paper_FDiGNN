...
with open('Data/LGD_GNNPathwayTest_graphlets_size5.txt') as a:
    gs = a.read().split('\n')

with open('Data/LGD_GNNPathwayTest_singlenodes_size5.txt') as a:
    sns_p = a.read().split('\n')
...
with open('Data/LGD_5Graphlets_gaps.txt') as a:
...
for r in datasets:
    ...
    torch.save(best_model.state_dict(), f'LGD_Models/LGD_model_Graphlets5Gap_4TAG_64HC3D005LR0001WD140E_{r}_{sys.argv[-1]}')
    print(f'Graphlets 5 Gap - {r} {sys.argv[-1]}.')
